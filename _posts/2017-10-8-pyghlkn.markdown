...
categories: music
tags: 
img: ../images/pyghlkn.jpg
---
* 
{:toc}
## 缘起

这个假期，我妈说最近在听《漂洋过海来看你》这首歌，我便打算要练下来，生日的时候送给她。其实说起来很少给妈妈唱歌，可能有点害羞吧，，但是能用自己的才艺让妈妈感到爱，还是很开心的😊。
...
[<span style="color: #0000ff;">关于作曲分析...</span>](http://localhost/wordpress/2017/09/26/zuoqufenxi/)
...
[<span style="color: #0000ff;">关于和弦分析...</span>](http://localhost/wordpress/2017/09/26/hexianfenxi/)

主歌用到的和弦进行是：I-ii-IV-V，属于基本的和弦进行。

![](../images/2017/09/a-1.png)

副歌用到的和弦进行是有：vi-iii-IV-V-I-ii-vi-ii-iii-vi。 大调中vi可以连接任何和弦，后面接iii，iii接IV也很常见，然后下属接属和弦再回到主和弦，没有问题，包括后面ii依次接了vi和iii，没有毛病。但最后一个和弦没有回到大调主和弦，而是落在了vi上（收尾在小调吗？），不太了解，回头继续学一些乐理知识再回来看看吧，听起来挺好的，有一种意犹未尽的忧伤感。

![](../images/2017/09/a-2.png)

#### 旋律分析

[<span style="color: #0000ff;">关于旋律分析...</span>](http://localhost/wordpress/2017/09/27/xuanlvfenxi/)
...
![](../images/2017/09/p1.png)

![](../images/2017/09/p2.png)

![](../images/2017/09/p3.png)

第四段过度到高潮，其实本来以为这就是副歌，但是由于和弦和前面主歌的完全一样，所以就作为主歌的过度吧。里面有跟多音音高一样，大概能出来“对爱情始终坚定如一”的感觉吧。

![](../images/2017/09/p4.png)

最后是副歌，只有一段，最后一个音没有落在大调主音上，似乎落在了小调上，倒不是很常见，留意一下。

![](../images/2017/09/p5.png)

### 编曲分析

[<span style="color: #0000ff;">关于编曲分析...</span>](http://localhost/wordpress/2017/09/26/bianqufenxi/)
...
![](../images/2017/09/l1.png)![](../images/2017/09/l2.png)

副歌的和弦替换跟前面都差不多，就不赘述了，最后一个和弦值得留意一下，V6和弦是第五级和弦的第一转位，还是一个挺常用的转位和弦，减少了V和弦对主和弦的倾向性，后面的谱子我也没有做了，但是的确是接了I极和弦，V6起了对 vi 和 I 的连接。

![](../images/2017/09/p5.png)

![](../images/2017/09/l3.png)

## 歌曲演唱

唱不太好，录了一半，歌曲倒不是特别难唱，可能经历不够吧，对歌曲中异地恋的那种感情并没有体会。 [embed]http://v.youku.com/v_show/id_XMjk5MjMxMTQ5Mg==.html?spm=a2hzp.8244740.0.0[/embed]

## 相关连接

<span style="color: #0000ff;">关于相关连接...</span> **父节点: [<span style="color: #0000ff;">音乐空间</span>](http://localhost/wordpress/music/)**