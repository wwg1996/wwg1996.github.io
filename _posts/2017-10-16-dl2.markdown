...
用于帮我们搜素出一组最优化的参数，让成本函数的值最小。梯度下降法所做的就是从初始点开始，朝最“抖”的下坡方向走一步。
...
![](http://wangweiguang.xyz/images/Computing_derivation.jpg)
...
# 作业
[https://www.coursera.org/learn/neural-networks-deep-learning/home/week/1](https://www.coursera.org/learn/neural-networks-deep-learning/home/week/1)
